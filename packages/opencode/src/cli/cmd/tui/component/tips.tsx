...
const TIPS = [
  ...
  "Run {highlight}/share{/highlight} to create a public link to your conversation at arcanea.ai",
  ...
  "Arcanea Code auto-handles OAuth for remote MCP servers requiring auth",
  ...
  "Arcanea Code auto-formats files using prettier, gofmt, ruff, and more",
  'Set {highlight}"formatter": false{/highlight} in config to disable all auto-formatting',
  "Define custom formatter commands with file extensions in config",
  "Arcanea Code uses LSP servers for intelligent code analysis",
  ...
  "Create a plugin to prevent Arcanea Code from reading sensitive files",
  "Use {highlight}arcanea-code run{/highlight} for non-interactive scripting",
  "Use {highlight}arcanea-code --continue{/highlight} to resume the last session",
  "Use {highlight}arcanea-code run -f file.ts{/highlight} to attach files via CLI",
  "Use {highlight}--format json{/highlight} for machine-readable output in scripts",
  "Run {highlight}arcanea-code serve{/highlight} for headless API access to Arcanea Code",
  "Use {highlight}arcanea-code run --attach{/highlight} to connect to a running server",
  "Run {highlight}arcanea-code upgrade{/highlight} to update to the latest version",
  "Run {highlight}arcanea-code auth list{/highlight} to see all configured providers",
  "Run {highlight}arcanea-code agent create{/highlight} for guided agent creation",
  "Use {highlight}/arcanea{/highlight} in GitHub issues/PRs to trigger AI actions",
  "Run {highlight}arcanea-code github install{/highlight} to set up the GitHub workflow",
  "Comment {highlight}/arcanea fix this{/highlight} on issues to auto-create PRs",
  ...
  "Run {highlight}arcanea-code debug config{/highlight} to troubleshoot configuration",
  ...
  "Run {highlight}docker run -it --rm ghcr.io/frankxai/arcanea-code{/highlight} for containerized use",
  "Use {highlight}/connect{/highlight} with Arcanea Zen for curated, tested models",
